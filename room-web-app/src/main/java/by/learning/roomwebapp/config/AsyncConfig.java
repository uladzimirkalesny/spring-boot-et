package by.learning.roomwebapp.config;

import by.learning.roomwebapp.async.RoomCleanerListener;
...
public class AsyncConfig {
    ...
    public Binding binding(Queue queue, TopicExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with("rooms.cleaner");
    }
